...
a=imread('rose.jpg'); % reading the image
a=im2double(a); % normalizing the instensity values to lie between o and 1

ref=a;
ad=imnoise(a,'speckle'); % adding Gaussian noise of mean zero and variance 0.01
...
psnr_value = psnr(a,ad);
title(['(PM)PSNR Value: ' num2str(psnr_value)]);